...
export default class ProductForm {
  ...
  createImages(data) {
    ...
    return new SortableList({ items: fragments });
  }  
  ...
  populateProductData() {
    ...
    const imageListContainer = form.querySelector('[data-element="imageListContainer"]');
    const sortableList = this.createImages(data.images);
